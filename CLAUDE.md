...
| `INSIDERFLOW_EXCLUDE_CATEGORIES` | `sports,crypto,weather` | Gamma category/tag substrings to reject — no-insider-signal classes (sports = gambling; crypto price levels and weather/natural disasters = privately unknowable) |
